  ...
  <div id="app" class="contain">
    ...
    <section v-else>
      <svg viewBox="0 -180 1628 1180" class="main">
        ...
        <g id="friendbubble">
          <path class="cls-45"
            d="M342.3 471.8h106.6c0 42.6-21.3 63.9-21.3 63.np9 64 0 85.3-63.9 85.3-63.9h42.6c42.7 0 42.7-42.7 42.7-42.7s21.3-149.3 21.3-191.9-42.6-42.7-42.6-42.7H321c-42.7 0-42.7 42.7-42.7 42.7l21.4 191.9s0 42.7 42.6 42.7z"
...
export default {
  ...
  methods: {
    ...
    pickQuestion(character) {
      ...
      // this.$store.commit("updateUIState", "questionChosen");
    },
